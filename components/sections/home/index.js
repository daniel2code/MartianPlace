...
const Main = () => {
  ...
  return (
    <div className="flex items-center w-full flex-wrap px-4 gap-x-14 mt-12 relative mb-10 md:mb-14">
      <div className="" >
        <Image src={martian} />
      </div>
      <div className="relative bottom-14 md:bottom-0">
        <h2
          className="text-[44px] leading-snug sm:text-[48px] font-semibold "
          style={{ color: "#CA21FE" }}
        >
        ...
        <div className="flex mt-12">
          <button
            ...
            className=" rounded-[50px] w-1/2 lg:w-fit px-10 sm:px-14  py-2 bg"
          >
            Discover
          </button>
          <button
