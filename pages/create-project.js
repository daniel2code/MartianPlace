...
const Index = () => {
  return (
    <>
      {/* <Modal /> */}
      <div className=" mt-20 mb-5 flex flex-col justify-center w-full items-center px-5">
        <div className="landing-page-container">
          ...
          <div className="grid grid-col-1 lg:grid-cols-3 gap-0 lg:gap-8 mt-10">
            <div className="md:col-span-1 col-span-2 mb-4 md:mb-0 m-auto">
              ...
              <div className="py-6 card-border bg-line-light rounded-lg px-5 mt-4">
              ...
              <div className="py-6 card-border bg-line-light rounded-lg px-5 mt-4">
                ...
                <p className={`${styles.text1} mt-5`}>
                  In order to keep this project going you can either buy a NFT
                  or donate MFuel tokens.
                </p>
            ...
            <div className="col-span-2">
              <div
                className={`${styles.topBox} py-4 card-border bg-line-light rounded-lg px-5 w-full flex items-center`}
              >
                <div className="flex">
                  <Image src={maskImg} />
              ...
              <div className="py-6 card-border bg-line-light rounded-lg px-5 w-full mt-6">
                <div className="flex items-center">
                ...
                <p className={`${styles.text1} mt-5`}>
                  ...
                  feugiat. Quis blandit turpis cursus in hac habitasse.
                  Venenatis urna cursus eget nunc scelerisque. Egestas integer
                  eget aliquet nibh praesent tristique magna. Eros in cursus{" "}
                  <br />
                  <br />
                  turpis massa tincidunt dui ut ornare. Faucibus in ornare quam
                  viverra orci sagittis eu volutpat. Suspendisse potenti nullam
                  ac tortor vitae purus faucibus ornare. Vestibulum morbi
                  blandit cursus risus. Imperdiet nulla malesuada pellentesque
                  elit eget gravida cum sociis natoque. Venenatis a condimentum
                  vitae sapien pellentesque. Dignissim sodales ut eu sem integer
                  vitae justo eget. Enim diam vulputate ut pharetra sit amet{" "}
                  <br />
                  <br />
                ...
                <div
                  className={`${styles.socialBox} card-border rounded-lg mt-8 flex`}
                >
                  <div
