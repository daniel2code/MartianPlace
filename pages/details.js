        ...
        <div className="landing-page-container">
          <div className="grid grid-col-1 lg:grid-cols-3 gap-0 lg:gap-8">
            <div className="lg:col-span-1 col-span-2 mb-4 lg:mb-0 m-auto">
              ...
              <div className="border w-full card-border bg-line-light rounded-xl mt-2 w-full">
                <p className="md:py-3 px-4 p-2">Movies</p>
                <Image src={CardImage} />
              </div>
              <div className="py-6 border card-border bg-line-light rounded-lg px-5 mt-4">
            ...
            <div className="col-span-2">
              ...
              <div className="flex items-center justify-between mt-9 py-4 border card-border bg-line-light rounded-lg px-5">
                <div className="flex items-center">
                  <Image src={binance} />
              ...
              <div className="mt-6 py-7 border card-border bg-line-light rounded-lg px-5">
                <div className="flex">
          ...
          <div className={`mt-8 w-full md:w-full w-full overflow-scroll`}>
            <div
              className={`${styles.mediumSize} py-6 border card-border bg-line-light rounded-lg mt-4`}
            >
