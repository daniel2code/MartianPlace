  ...
  return (
    ...
    <nav className={`${navStyles.nav} flex flex-wrap justify-between pt-3 lg:px-2`} >
      <ul className='flex'>
        ...
        <li className='hidden lg:block mt-2 mx-3'><span>|</span></li>
        <li className='hidden lg:block mt-2 mx-3'>
        ...
        <li>
        {/* <Search /> */}
          <Input leftIcon={{ src: thesearch, alt: 'icon' }} inputstyles={`shadow-inner lg:px-2 px-1 py-1 md:w-96 w-60 border-none
      ...
      <ul className='flex'>
        <li className='hidden lg:block mt-2 mx-3'>
          <Button
            ...
            onClick={onWallet}
            ><span className='hidden lg:block'>{ active ? "Wallet connected" : "Connect Wallet" }</span>
        ...
        <li className='lg:hidden mr-2 mt-1'>
          <Button
            ...
            onClick={handleMobileMenu}>
              {openMenu ? <Image src={CloseIcon} alt={'menu'} width={26} height={26} ></Image>
              :<Image src={MenuIcon} alt={'menu'} width={26} height={26} ></Image>}
            </Button>
        </li>
      </ul>
      <div
